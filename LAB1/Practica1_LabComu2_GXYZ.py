...
class Practica1_LabComu2_GXYZ(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "Practica1_LabComu2_GXYZ")
        ...
        # Blocks
        ##################################################
        self._fc_range = Range(50000000, 2200000000, 1000000, 100000000, 200)
        self._fc_win = RangeWidget(self._fc_range, self.set_fc, "Fracuencia portadora", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._fc_win)
        self._NO_range = Range(0.000001, 0.5, 0.000001, 0.250, 200)
        ...
        self._GTX_range = Range(0, 100, 1, 50, 200)
...
def main(top_block_cls=Practica1_LabComu2_GXYZ, options=None):
